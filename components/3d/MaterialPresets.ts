...
export type MaterialPresetId = 'frost' | 'satin' | 'glass' | 'chrome' | 'pearl' | 'lacquer' | 'custom';
...
const applySurfaceEmissive = <T extends THREE.Material>(material: T, intensity: number): T => {
...
const withBaseOpacity = <T extends THREE.Material>(material: T): T => {
  material.userData.baseOpacity = (material as any).opacity ?? 1;
...
export function createThreeMaterial(
  ...
  const withSurfaceEmissive = <T extends THREE.Material>(material: T, intensity: number): T =>
  ...
  const withReflectance = <T extends THREE.Material>(material: T): T => {
    const envIntensity = preset === 'chrome'
      ? Math.max(1.8, reflectance * 2.4)
      : reflectance;
    (material as any).reflectivity = reflectance;
    (material as any).envMapIntensity = envIntensity;
    return material;
  };

  switch (preset) {
    case 'frost':
      const frostMaterial = withSurfaceEmissive(withReflectance(new THREE.MeshPhysicalMaterial({
        color,
        roughness: props.roughness !== undefined ? props.roughness : 0.72,
        metalness: props.metalness !== undefined ? props.metalness : 0.0,
        transmission: props.transmission !== undefined ? props.transmission : 0.28,
        thickness: props.thickness !== undefined ? props.thickness : 0.65,
        ior: 1.42,
        clearcoat: props.clearcoat !== undefined ? props.clearcoat : 0.18,
        clearcoatRoughness: props.clearcoatRoughness !== undefined ? props.clearcoatRoughness : 0.62,
        emissive: emissiveColor,
        emissiveIntensity: usesSurfaceColor ? 0 : (props.emissiveIntensity !== undefined ? props.emissiveIntensity : 0.035),
        wireframe,
        transparent: true,
        opacity,
        depthWrite: true,
    ...
    case 'satin':
      return withSurfaceEmissive(withReflectance(new THREE.MeshStandardMaterial({
        color,
        roughness: props.roughness !== undefined ? props.roughness : 0.34,
        metalness: props.metalness !== undefined ? props.metalness : 0.03,
        emissive: emissiveColor,
        emissiveIntensity: props.emissiveIntensity !== undefined ? props.emissiveIntensity : 0.12,
        wireframe,
    ...
    case 'chrome':
      const metalColor = usesSurfaceColor ? new THREE.Color('#ffffff') : color.clone().lerp(new THREE.Color('#ffffff'), 0.18);
      return withSurfaceEmissive(withReflectance(new THREE.MeshPhysicalMaterial({
        color: metalColor,
        roughness: props.roughness !== undefined ? props.roughness : 0.075,
        metalness: props.metalness !== undefined ? Math.min(props.metalness, 0.52) : 0.48,
        emissive: emissiveColor,
        emissiveIntensity: usesSurfaceColor ? 0 : Math.max(props.emissiveIntensity ?? 0, 0.08),
        clearcoat: props.clearcoat !== undefined ? props.clearcoat : 1.0,
        clearcoatRoughness: props.clearcoatRoughness !== undefined ? props.clearcoatRoughness : 0.02,
        sheen: 0.35,
        sheenRoughness: 0.18,
    ...
    case 'pearl':
      const pearlBase = usesSurfaceColor ? new THREE.Color('#ffffff') : color.clone().lerp(new THREE.Color('#ffffff'), 0.38);
      return withSurfaceEmissive(withReflectance(new THREE.MeshPhysicalMaterial({
        color: pearlBase,
        roughness: props.roughness !== undefined ? props.roughness : 0.42,
        metalness: props.metalness !== undefined ? props.metalness : 0.0,
        clearcoat: props.clearcoat !== undefined ? props.clearcoat : 0.72,
        clearcoatRoughness: props.clearcoatRoughness !== undefined ? props.clearcoatRoughness : 0.22,
        sheen: 0.72,
        sheenRoughness: 0.38,
    ...
    case 'lacquer':
      return withSurfaceEmissive(withReflectance(new THREE.MeshPhysicalMaterial({
        ...
        metalness: props.metalness !== undefined ? props.metalness : 0.0,
        clearcoat: props.clearcoat !== undefined ? props.clearcoat : 1.0,
        clearcoatRoughness: props.clearcoatRoughness !== undefined ? props.clearcoatRoughness : 0.03,
        emissive: emissiveColor,
        emissiveIntensity: props.emissiveIntensity !== undefined ? props.emissiveIntensity : 0.04,
        wireframe,
        transparent: opacity < 1.0,
        opacity,
        map,
    ...
    case 'custom':
      return withReflectance(new THREE.MeshPhysicalMaterial({
        color,
